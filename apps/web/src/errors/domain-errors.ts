...
export function createCrisprError (message: string,
  code: ErrorCode,
  context?: Record<string, unknown>): CrisprError {
  return new CrisprError(message, code, context)
}

export function createValidationError (message: string,
  code: ErrorCode,
  context?: Record<string, unknown>): ValidationError {
  return new ValidationError(message, code, context)
}

export function createAIError (message: string,
  code: ErrorCode,
  context?: Record<string, unknown>): AIError {
  return new AIError(message, code, context)
}

export function createRepositoryError (message: string,
  code: ErrorCode,
  context?: Record<string, unknown>): RepositoryError {
